...
const Footer = () => {
  ...
  const socialLinks = [
    {
      label: 'GitHub',
      href: 'https://github.com/Ngoc-Trong2211',
      icon: (
    ...
    {
      label: 'Facebook',
      href: 'https://www.facebook.com/share/1HWT9qg6m8/?mibextid=wwXIfr',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/gnortcogn.87664',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    {
      label: 'Email',
      href: 'https://mail.google.com/mail/?view=cm&fs=1&to=trongpvn2211@gmail.com',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <ul className="footer__list">
                {techStack.map((tech) => (
                  <li key={tech} className="footer__list-item">
                    <span className="footer__tech-item">{tech}</span>
                  </li>
                ))}
              </ul>
            </div>
                ...
                {socialLinks.map(({ label, href, icon }) => (
                  <li key={label} className="footer__social-item">
                    ...
                    >
                      ...
                      <span className="footer__social-label">{label}</span>
                    </a>
                  </li>
                ))}
              </ul>
